...
The configs in the "root" directory contains a `gamestore` namespace and a `RepoSync` resource in the `gamestore` namespacing, referencing the "gamestore" directory in this git repository.
